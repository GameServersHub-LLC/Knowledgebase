...
import { j as useData, g as dataSymbol, p as pathToFile, u as useRouter, k as createSearchTranslate, i as inBrowser, l as escapeRegExp } from "./VPTeamMembers.nQ5m-b7z.js";
import { _ as _export_sfc } from "./plugin-vue_export-helper.1tPrXgE0.js";
const localSearchIndex = { "root": () => import("./@localSearchIndexroot.d0G84REL.js") };
class LRUCache {
  constructor(max = 10) {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        var _a2, _b2, _c, _d;
        _push2(`<div role="button"${ssrRenderAttr("aria-owns", ((_a2 = results.value) == null ? void 0 : _a2.length) ? "localsearch-list" : void 0)} aria-expanded="true" aria-haspopup="listbox" aria-labelledby="localsearch-label" class="VPLocalSearchBox" data-v-4d7f898a><div class="backdrop" data-v-4d7f898a></div><div class="shell" data-v-4d7f898a><form class="search-bar" data-v-4d7f898a><label${ssrRenderAttr("title", buttonText.value)} id="localsearch-label" for="localsearch-input" data-v-4d7f898a><span aria-hidden="true" class="vpi-search search-icon local-search-icon" data-v-4d7f898a></span></label><div class="search-actions before" data-v-4d7f898a><button class="back-button"${ssrRenderAttr("title", unref(translate)("modal.backButtonTitle"))} data-v-4d7f898a><span class="vpi-arrow-left local-search-icon" data-v-4d7f898a></span></button></div><input${ssrRenderAttr("value", unref(filterText))}${ssrRenderAttr("placeholder", buttonText.value)} id="localsearch-input" aria-labelledby="localsearch-label" class="search-input" data-v-4d7f898a><div class="search-actions" data-v-4d7f898a>`);
        if (!disableDetailedView.value) {
          _push2(`<button type="button" class="${ssrRenderClass([{ "detailed-list": unref(showDetailedList) }, "toggle-layout-button"])}"${ssrRenderAttr("title", unref(translate)("modal.displayDetails"))} data-v-4d7f898a><span class="vpi-layout-list local-search-icon" data-v-4d7f898a></span></button>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`<button class="clear-button" type="reset"${ssrIncludeBooleanAttr(disableReset.value) ? " disabled" : ""}${ssrRenderAttr("title", unref(translate)("modal.resetButtonTitle"))} data-v-4d7f898a><span class="vpi-delete local-search-icon" data-v-4d7f898a></span></button></div></form><ul${ssrRenderAttr("id", ((_b2 = results.value) == null ? void 0 : _b2.length) ? "localsearch-list" : void 0)}${ssrRenderAttr("role", ((_c = results.value) == null ? void 0 : _c.length) ? "listbox" : void 0)}${ssrRenderAttr("aria-labelledby", ((_d = results.value) == null ? void 0 : _d.length) ? "localsearch-label" : void 0)} class="results" data-v-4d7f898a><!--[-->`);
        ssrRenderList(results.value, (p, index) => {
          _push2(`<li role="option"${ssrRenderAttr("aria-selected", selectedIndex.value === index ? "true" : "false")} data-v-4d7f898a><a${ssrRenderAttr("href", p.id)} class="${ssrRenderClass([{
            selected: selectedIndex.value === index
          }, "result"])}"${ssrRenderAttr("aria-label", [...p.titles, p.title].join(" > "))} data-v-4d7f898a><div data-v-4d7f898a><div class="titles" data-v-4d7f898a><span class="title-icon" data-v-4d7f898a>#</span><!--[-->`);
          ssrRenderList(p.titles, (t, index2) => {
            _push2(`<span class="title" data-v-4d7f898a><span class="text" data-v-4d7f898a>${t ?? ""}</span><span class="vpi-chevron-right local-search-icon" data-v-4d7f898a></span></span>`);
          });
          _push2(`<!--]--><span class="title main" data-v-4d7f898a><span class="text" data-v-4d7f898a>${p.title ?? ""}</span></span></div>`);
          if (unref(showDetailedList)) {
            _push2(`<div class="excerpt-wrapper" data-v-4d7f898a>`);
            if (p.text) {
              _push2(`<div class="excerpt" inert data-v-4d7f898a><div class="vp-doc" data-v-4d7f898a>${p.text ?? ""}</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="excerpt-gradient-bottom" data-v-4d7f898a></div><div class="excerpt-gradient-top" data-v-4d7f898a></div></div>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div></a></li>`);
        ...
        if (unref(filterText) && !results.value.length && enableNoResults.value) {
          _push2(`<li class="no-results" data-v-4d7f898a>${ssrInterpolate(unref(translate)("modal.noResultsText"))} &quot;<strong data-v-4d7f898a>${ssrInterpolate(unref(filterText))}</strong>&quot; </li>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`</ul><div class="search-keyboard-shortcuts" data-v-4d7f898a><span data-v-4d7f898a><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.navigateUpKeyAriaLabel"))} data-v-4d7f898a><span class="vpi-arrow-up navigate-icon" data-v-4d7f898a></span></kbd><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.navigateDownKeyAriaLabel"))} data-v-4d7f898a><span class="vpi-arrow-down navigate-icon" data-v-4d7f898a></span></kbd> ${ssrInterpolate(unref(translate)("modal.footer.navigateText"))}</span><span data-v-4d7f898a><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.selectKeyAriaLabel"))} data-v-4d7f898a><span class="vpi-corner-down-left navigate-icon" data-v-4d7f898a></span></kbd> ${ssrInterpolate(unref(translate)("modal.footer.selectText"))}</span><span data-v-4d7f898a><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.closeKeyAriaLabel"))} data-v-4d7f898a>esc</kbd> ${ssrInterpolate(unref(translate)("modal.footer.closeText"))}</span></div></div></div>`);
      }, "body", false, _parent);
    };
  }
});
...
const VPLocalSearchBox = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4d7f898a"]]);
export {
