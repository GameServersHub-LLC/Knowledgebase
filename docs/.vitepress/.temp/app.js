import { L as Layout, _ as _sfc_main$1, u as useRouter, i as inBrowser, c as createTitle, m as mergeHead, d as useRoute, p as pathToFile, e as useData, R as RouterSymbol, f as initData, g as dataSymbol, C as Content, s as siteDataRef, h as createRouter } from "./VPTeamMembers.nQ5m-b7z.js";
import { useSSRContext, onMounted, unref, defineComponent, ref, watchEffect, watch, onUnmounted, h, createSSRApp } from "vue";
...
const theme = {
  Layout,
  enhanceApp: ({ app }) => {
    app.component("Badge", _sfc_main$1);
  }
};
const _sfc_main = {
  __name: "layout",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Layout2), _attrs, null, _parent));
    };
  }
};
