...
> [!IMPORTANT]
> Please be sure to add `CurveOverrides=(CurveName="Dunkleosteus.` in front of every line in the `Game.ini` under [/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`Dunkleosteus`
...
Core.CombatWeight",Values=(150,862.5,1575,2287.5,2800))
...
Core.BodyFoodAmount",Values=(100,225,350,475,800))
Core.MaxHunger",Values=(50,212.5,375,437.5,500))
...
Core.FoodConsumptionRate",Values=(40,50,60,70,80))
Core.WaterConsumptionRate",Values=(20,30,40,50,55))
Core.MaxOxygen",Values=(5,5,5,5,5))
...
Core.StaminaRecoveryRate",Values=(1.2,1.2,1.2,1.2,1.2))
...
Multiplier.BoneBreakSubSpecies.BoneBreak",Values=(1.15,1.15,1.15,1.15,1.15))
...
StaminaSprintCostPerSecond",Values=(3,5,5,7,10))
StaminaSwimgCostPerSecond",Values=(0,0,0,0,0))
StaminaTrotSwimCostPerSecond",Values=(0,0,0,0,0))
StaminaFastSwimCostPerSecond",Values=(0.3,0.3,0.3,0.3,0.3))
StaminaDiveCostPerSecond",Values=(0,0,0,0,0))
StaminaFastDiveCostPerSecond",Values=(0.3,0.3,0.3,0.3,0.3))
...
BiteBoneBreakChance",Values=(2,2,2,2,2))
BiteBoneBreakAmount",Values=(0.5,0.5,0.5,0.5,0.5))
BiteStaminaCost",Values=(0,0,0,0,0))
BiteCooldown",Values=(1.5,1.5,1.5,1.5,1.5))
StubbornDamageResist",Values=(0.45,0.45,0.45,0.45,0.45))
StubbornCooldown",Values=(8,8,8,8,8))
FuryDamageBuff",Values=(1.01,1.01,1.01,1.01,1.01))
FuryDuration",Values=(12.5,12.5,12.5,12.5,12.5))
AmbushSpeedMultiplier",Values=(1.7,1.7,1.7,1.7,1.7))
AmbushSpeedDuration",Values=(20,20,20,20,20))
AmbushCooldown",Values=(40,40,40,40,40))
AmbushStaminaCost",Values=(7.5,7.5,7.5,7.5,7.5))
AmbushSpeed",Values=(400,600,800,1000,1200))
RammingSpeedDamage",Values=(20,30,40,50,70))
RammingSpeedBoneBreakAmount",Values=(4,4,4,4,4))
RammingSpeedCooldown",Values=(8,8,8,8,8))
RammingSpeedStaminaCost",Values=(5,5,5,5,5))
RammingSpeedSpeed",Values=(400,600,800,1000,1200))
RendingChompDamage",Values=(20,20,40,50,60))
RendingChompDuration",Values=(20,20,20,20,20))
RendingChompCooldown",Values=(5,5,5,5,5))
RendingChompStaminaCost",Values=(10,10,10,10,10))
CrushingBiteDamage",Values=(20,20,30,35,40))
CrushingBiteBoneBreakAmount",Values=(5,5,5,5,5))
CrushingBiteCooldown",Values=(7,7,7,7,7))
CrushingBiteStaminaCost",Values=(5,5,5,5,5))
TailAttackDamage",Values=(1,5,10,15,20))
TailAttackCooldown",Values=(1.5,1.5,1.5,1.5,1.5))
```
