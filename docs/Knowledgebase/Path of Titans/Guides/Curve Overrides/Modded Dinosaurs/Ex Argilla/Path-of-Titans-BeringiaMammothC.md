...
title: BeringiaMammothC
---

# Path of Titans BeringiaMammothC
...
> [!IMPORTANT]
> Please be sure to add `CurveOverrides=(CurveName="BeringiaMammothC.` in front of every line in the `Game.ini` under [/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`BeringiaMammothC`

## Attributes:

```cs
Core.MaxHealth",Values=(300,475,650,790,800))
Core.MaxStamina",Values=(100,100,100,100,100))
Core.CombatWeight",Values=(500,1200,2750,4600,6500))
...
Core.FoodConsumptionRate",Values=(20,40,70,90,120))
Core.WaterConsumptionRate",Values=(20,40,70,90,120))
...
Core.HealthRecoveryRate",Values=(1.67,1.38,1.3,1.27,1.25))
Core.StaminaRecoveryRate",Values=(1,0.6,0.5,0.4,0.4))
...
Multiplier.StaminaRecovery.Walking",Values=(1,1,1,1,1.2))
Multiplier.StaminaRecovery.Trotting",Values=(0.9,0.9,0.9,0.9,0.9))
Multiplier.StaminaRecovery.Sprinting",Values=(0.75,0.75,0.75,0.75,0.75))
...
Multiplier.OxygenRecovery.Resting",Values=(0,0,0,0,0))
...
Multiplier.BleedingRate.Resting",Values=(0,0,0,0,0))
Multiplier.BleedingRate.Sleeping",Values=(0.75,0.75,0.75,0.75,0.75))
Multiplier.BleedingRate.Standing",Values=(0.5,0.5,0.5,0.5,0.5))
...
Multiplier.BleedingHealRate.Resting",Values=(0,0,0,0,0))
...
Multiplier.PoisonHealRate.Resting",Values=(0,0,0,0,0))
...
Multiplier.VenomRate.Resting",Values=(0,0,0,0,0))
...
Multiplier.VenomHealRate.Diving",Values=(0.25,0.25,0.25,0.25,0.25))
Multiplier.VenomHealRate.TrotDiving",Values=(1,1,1,1,1))
Multiplier.VenomHealRate.FastDiving",Values=(1,1,1,1,1))
Multiplier.VenomHealRate.Crouching",Values=(0.25,0.25,0.25,0.25,0.25))
...
Multiplier.HungerDepletionRate.Resting",Values=(0,0,0,0,0))
...
Multiplier.ThirstDepletionRate.Resting",Values=(0,0,0,0,0))
...
Multiplier.HungerDamage.Resting",Values=(0,0,0,0,0))
...
Multiplier.ThirstDamage.Resting",Values=(0,0,0,0,0))
...
Multiplier.IncomingDamage.Sleeping",Values=(1.5,1.5,1.5,1.5,1.5))
...
StaminaSprintCostPerSecond",Values=(0.42,1.15,1.88,2.6,3.33))
StaminaSwimgCostPerSecond",Values=(1.67,1.67,1.67,1.67,1.67))
StaminaTrotSwimCostPerSecond",Values=(1.67,1.67,1.67,1.67,1.67))
StaminaFastSwimCostPerSecond",Values=(3.33,3.33,3.33,3.33,3.33))
StaminaJumpCost",Values=(0,0,0,0,0))
DefenseBuffCost",Values=(10,10,10,10,10))
DefenseBuffDuration",Values=(60,60,60,60,60))
DefenseBuffMultiplier",Values=(1.2,1.2,1.2,1.3,1.4))
...
BeringiaMammothCStompCooldown",Values=(4,4,4,4,4))
StompStaminaCost",Values=(10,10,10,10,10))
ChargeSpeedIncrease",Values=(500,1000,1000,1000,1000))
ChargeDuration",Values=(9,9,9,10,13))
ChargeCooldown",Values=(80,80,80,80,80))
ChargeCost",Values=(50,50,50,50,50))
ChargeDamage",Values=(100,100,100,100,110))
