...
> [!IMPORTANT]
> Please be sure to add `CurveOverrides=(CurveName="KTODeino.` in front of every line in the `Game.ini` under [/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`KTODeino`

## Attributes:

```cs
Core.MaxHealth",Values=(100,475,650,800,900))
Core.MaxStamina",Values=(100,100,100,100,100))
Core.CombatWeight",Values=(500,1450,3125,4200,6500))
Core.Armor",Values=(1,1,1,1.05,1.1))
...
Core.BodyFoodAmount",Values=(50,500,1000,1800,2200))
Core.MaxHunger",Values=(50,237,425,700,1000))
Core.MaxThirst",Values=(50,237,425,700,1000))
Core.HungerDepletionRate",Values=(0.02,0.08,0.17,0.25,0.32))
Core.ThirstDepletionRate",Values=(0.02,0.15,0.2,0.27,0.37))
Core.FoodConsumptionRate",Values=(20,50,75,100,120))
Core.WaterConsumptionRate",Values=(9,21,42,64,85))
...
Core.HealthRecoveryRate",Values=(1.66,1.31,1.19,1.14,0.82))
Core.StaminaRecoveryRate",Values=(1,0.85,0.7,0.6,0.55))
Core.JumpForceMultiplier",Values=(2,1.3,1,0,0))
Core.GrowthPerSecond",Values=(1,1,1,1,1))
Core.FallDeathSpeed",Values=(2000,2000,2000,2000,2000))
Core.TurnRadiusMultiplier",Values=(2,1.75,1.5,1.2,1))
...
Core.CarryCapacity",Values=(200,900,1700,2800,4001))
```
...
Multiplier.DrenchedScales.LandSpeed",Values=(1.15,1.15,1.15,1.15,1.15))
...
```cs
BiteDamage",Values=(20,30,30,60,80))
...
StaminaSprintCostPerSecond",Values=(3.3,5,5,5,6.67))
StaminaSwimgCostPerSecond",Values=(0,0,0,0,0))
StaminaTrotSwimCostPerSecond",Values=(0,0,0,0,0))
StaminaFastSwimCostPerSecond",Values=(0.15,0.22,0.22,0.22,0.3))
StaminaDiveCostPerSecond",Values=(0,0,0,0,0))
StaminaFastDiveCostPerSecond",Values=(0.15,0.22,0.22,0.22,0.3))
StaminaTrotDiveCostPerSecond",Values=(0,0,0,0,0))
StaminaJumpCost",Values=(30,30,30,30,30))
BoneSnapDamage",Values=(1,5,22.5,45,60))
BoneSnapBoneBreakChance",Values=(2,2,2,2,2))
BoneSnapCooldown",Values=(3,3,3,3,3))
BoneSnapStaminaCost",Values=(5,5,5,5,5))
BoneSnapBoneBreakAmount",Values=(15,15,15,15,15))
TailSwipeDamage",Values=(1,5,15,25,35))
TailSwipeCooldown",Values=(3,3,3,3,3))
LungeDamage",Values=(1,7.5,30,60,80))
LungeBoneBreakChance",Values=(1,1,1,1,1))
LungeBoneBreakAmount",Values=(0.01,0.01,0.01,0.01,0.01))
LungeCooldown",Values=(15,15,15,15,15))
LungeStaminaCost",Values=(30,30,30,30,30))
LungeSpeed",Values=(100,400,800,1300,2000))
LungeFractureSpeedDebuff",Values=(0.5,0.5,0.5,0.5,0.5))
SpeedBuffCrouchStrenght",Values=(200,300,400,600,800))
SpeedBuffCrouchCooldown",Values=(60,60,60,60,60))
SpeedBuffCrouchStaminaCost",Values=(10,10,10,10,10))
SpeedBuffCrouchSpeedDuration",Values=(30,30,30,30,30))
SpeedBuffCrouchSpeedMultiplier",Values=(1.15,1.15,1.15,1.15,1.15))
SpeedLungeCooldown",Values=(20,20,20,20,20))
SpeedLungeSpeed",Values=(1000,1000,1000,1000,1000))
SpeedLungeStaminaCost",Values=(15,15,15,15,15))
DeathrollDamage",Values=(30,50,80,110,140))
DeathrollCooldown",Values=(4,4,4,4,4))
DeathrollStaminaCost",Values=(10,10,10,10,10))
90BiteDamage",Values=(20,30,30,60,80))
90BiteCooldown",Values=(4,4,4,4,4))
90BiteStaminaCost",Values=(8,8,8,8,8))
180BiteDamage",Values=(1,5,22.5,45,60))
180BiteCooldown",Values=(6,6,6,6,6))
180BiteStaminaCost",Values=(15,15,15,15,15))
WaterVisionMultiplier",Values=(3,3,3,3,3))
ClampDamage",Values=(0,0,0,0,0))
ClampCarryStaminaCost",Values=(0.15,0.15,0.15,0.15,0.15))
ClampCooldown",Values=(7,7,7,7,7))
ClampStaminaCost",Values=(5,5,5,5,5))
```
