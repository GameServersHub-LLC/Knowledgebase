...
> [!IMPORTANT]
> Please be sure to add `CurveOverrides=(CurveName="IgnisOphis.` in front of every line in the `Game.ini` under [/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`IgnisOphis`

## Attributes:

```cs
Core.MaxHealth",Values=(300,470,650,755,900))
Core.MaxStamina",Values=(100,100,100,100,100))
Core.CombatWeight",Values=(500,1600,3070,5250,6500))
...
Core.BodyFoodAmount",Values=(700,1200,1500,1800,2200))
Core.MaxHunger",Values=(50,200,500,700,1000))
Core.MaxThirst",Values=(50,200,500,700,1000))
Core.HungerDepletionRate",Values=(0.01,0.1,0.12,0.15,0.2))
Core.ThirstDepletionRate",Values=(0.02,0.07,0.08,0.1,0.15))
Core.FoodConsumptionRate",Values=(25,50,75,100,120))
Core.WaterConsumptionRate",Values=(25,50,75,100,120))
...
Core.HealthRecoveryRate",Values=(1,1,1,1,0.91))
Core.StaminaRecoveryRate",Values=(3,2.5,2,1.75,1.5))
Core.JumpForceMultiplier",Values=(1.8,1.5,1,0,0))
...
Multiplier.StaminaSubSpecies.Drain",Values=(0.85,0.85,0.85,0.95,0.85))
Multiplier.AccelerationSubSpecies.Speed",Values=(1.5,1.5,1.5,1.5,1.5))
Multiplier.KnockbackSubSpecies.Reduction",Values=(1.5,1.5,1.5,1.5,1.5))
Multiplier.WaterRecovery.Swim",Values=(0.3,0.3,0.3,0.3,0.3))
Multiplier.WaterRecovery.FastSwim",Values=(0.3,0.3,0.3,0.3,0.3))
...
```cs
BiteDamage",Values=(30,40,50,60,70))
...
StaminaSprintCostPerSecond",Values=(0.3,2,3,5,6.6))
StaminaSwimgCostPerSecond",Values=(0,0,0,0,0))
StaminaFastSwimCostPerSecond",Values=(0.4,0.4,0.4,0.4,0.4))
StaminaDiveCostPerSecond",Values=(0,0,0,0,0))
StaminaFastDiveCostPerSecond",Values=(0.4,0.4,0.4,0.4,0.4))
StaminaJumpCost",Values=(6.67,6.67,6.67,6.67,6.67))
TailAttackDamage",Values=(25,25,30,30,30))
...
BiteVenomDamage",Values=(25,30,35,45,50))
BiteVenomBoneBreakChance",Values=(0,0,0,0,0))
BiteVenomBleedAmount",Values=(0,0,0,0,0))
BiteVenomAmount",Values=(1,0.5,0.5,0.25,0.15))
BiteVenomCooldown",Values=(1.5,1.5,1.5,1.5,1.5))
BiteVenomStaminaCost",Values=(0,0,0,0,0))
BiteVenomPotencyDuration",Values=(10,10,10,10,10))
BiteVenomPotencyDebuff",Values=(5,5,5,5,5))
BiteBonebreakCooldown",Values=(8,8,8,8,8))
BiteBonebreakStaminaCost",Values=(10,10,10,10,10))
LegsLungeDamage",Values=(15,25,30,45,50))
LegsLungeBoneBreakChance",Values=(2,2,2,2,2))
LegsLungeBoneBreakAmount",Values=(10,10,10,10,10))
LegsLungeBleedAmount",Values=(0,0,0,0,0))
LegsLungeCooldown",Values=(30,30,30,30,30))
LegsLungeStaminaCost",Values=(20,20,20,20,20))
LegsLungeSpeed",Values=(700,2000,3000,5000,5500))
```
