...
> [!IMPORTANT]
> Please be sure to add `CurveOverrides=(CurveName="PTSachicasaurus.` in front of every line in the `Game.ini` under [/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`PTSachicasaurus`
...
Core.CombatWeight",Values=(500,1400,3025,4100,6700))
...
Core.HealthRecoveryRate",Values=(1.67,1.32,1.2,1.15,1))
Core.StaminaRecoveryRate",Values=(1.5,1.1,0.89,0.66,0.33))
...
Core.CarryCapacity",Values=(200,900,1600,2300,4000))
```
...
Multiplier.MobySubSpecies.Stamina",Values=(0.8,0.8,0.8,0.8,0.8))
Multiplier.MobySubSpecies.Damage",Values=(1.07,1.07,1.07,1.07,1.07))
...
```cs
BiteDamage",Values=(20,35,50,70,90))
...
StaminaFastSwimCostPerSecond",Values=(0.66,0.66,0.66,0.66,0.66))
StaminaTrotSwimCostPerSecond",Values=(0,0,0,0,0))
StaminaDiveCostPerSecond",Values=(0,0,0,0,0))
StaminaFastDiveCostPerSecond",Values=(0.33,0.33,0.33,0.33,0.33))
...
BreachStrength",Values=(1200,1500,1600,1800,2000))
BreachRiseDuration",Values=(2.5,2.5,2.5,2.5,2.5))
AileronRollDamage",Values=(20,30,40,50,60))
AileronRollCooldown",Values=(5,5,5,5,5))
AileronRollStaminaCost",Values=(0,0,0,0,0))
AileronRollSpeed",Values=(400,600,800,1000,1200))
CrushingBiteDamage",Values=(40,40,40,40,40))
CrushingBoneBreakAmount",Values=(30,30,30,30,30))
CrushingBiteCooldown",Values=(5,5,5,5,5))
CrushingBiteStaminaCost",Values=(10,10,10,10,10))
LungeDamage",Values=(20,30,40,50,60))
LungeCooldown",Values=(5,5,5,5,5))
LungeStaminaCost",Values=(10,10,10,10,10))
LungeSpeed",Values=(400,600,800,1000,1200))
ClampDamage",Values=(10,10,10,10,10))
ClampCooldown",Values=(5,5,5,5,5))
ClampStaminaCost",Values=(0,0,0,0,0))
ClampCarryStaminaCost",Values=(1,1,1,1,1))
ThrashDamage",Values=(5,5,15,20,25))
