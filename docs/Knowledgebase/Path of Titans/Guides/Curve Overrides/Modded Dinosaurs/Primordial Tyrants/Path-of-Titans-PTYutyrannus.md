...
> [!IMPORTANT]
> Please be sure to add `CurveOverrides=(CurveName="PTYutyrannus.` in front of every line in the `Game.ini` under [/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`PTYutyrannus`
...
Core.CombatWeight",Values=(500,1100,1850,2600,3250))
...
StaminaFastDiveCostPerSecond",Values=(6.14,6.14,6.14,6.14,6.14))
StaminaJumpCost",Values=(12,12,12,12,12))
...
BuffStaminaMultiplier",Values=(2,2,2,2,2))
BuffStaminaRadius",Values=(3000,3000,3000,3000,3000))
BuffStaminaCost",Values=(10,10,10,10,10))
BuffStaminaCooldown",Values=(90,90,90,90,90))
BuffStaminaDuration",Values=(30,30,30,30,30))
BuffBleedMultiplier",Values=(2,2,2,2,2))
BuffBleedRadius",Values=(3000,3000,3000,3000,3000))
