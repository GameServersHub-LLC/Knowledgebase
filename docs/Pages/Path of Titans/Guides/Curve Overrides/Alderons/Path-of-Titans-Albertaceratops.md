...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Albertaceratops.` in front of every line in the `Game.ini` under [/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`Albertaceratops`

## Attributes:
```cs
Core.MaxHealth,Values=(150,310,500,625,800))
Core.MaxStamina,Values=(100,100,100,100,100))
Core.CombatWeight,Values=(500,1000,1750,2500,3500))
...
KickBoneBreakChance,Values=(0,0,0.01,0.03,0.05))
KickCooldown,Values=(1.25,1.25,1.25,1.25,1.25))
KickBleedAmount,Values=(0,0,0,0,0))
ChargeSpeedIncrease,Values=(400,600,1000,1200,1400))
