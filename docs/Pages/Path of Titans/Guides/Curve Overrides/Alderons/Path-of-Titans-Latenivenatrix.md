...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Latenivenatrix.` in front of every line in the `Game.ini` under [/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`Latenivenatrix`
...
BarkBuffCost,Values=(10,10,10,10,10))
BarkBuffCooldown,Values=(20,20,20,20,20))
BarkBuffAttackBuff,Values=(1.08,1.08,1.08,1.08,1.08))
BarkBuffDuration,Values=(20,20,20,20,20))
...
CallOfTheNightTerrorsDuration,Values=(60,60,60,60,60))
NightHunterAttackBuff,Values=(1.15,1.15,1.15,1.15,1.15))
