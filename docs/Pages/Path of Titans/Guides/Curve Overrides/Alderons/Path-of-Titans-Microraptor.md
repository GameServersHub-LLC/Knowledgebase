...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Microraptor.` in front of every line in the `Game.ini` under [/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`Microraptor`

## Attributes:
```cs
Core.MaxHealth",Values=(100,200,300,400,100))
Core.MaxStamina",Values=(50,100,100,100,100))
Core.CombatWeight",Values=(10,20,30,40,400))
...
Core.ThirstDepletionRate",Values=(0.25,0.15,0.15,0.15,0.15))
Core.FoodConsumptionRate",Values=(1,1,1,1,1))
Core.WaterConsumptionRate",Values=(1,1,1,1,1))
...
Core.HealthRecoveryRate",Values=(1,2,3,4,5))
...
StaminaSwimgCostPerSecond",Values=(3,5,5,7,10))
