...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Nyctatyrannus.` in front of every line in the `Game.ini` under [/Script/PathOfTitans.IGameSession]`
...
Core.MovementSpeedMultiplier,Values=(1.05,1.05,1.05,1.05,1.05))
...
Core.StaminaRecoveryRate,Values=(2.5,2,1.5,0.86,0.75))
Core.JumpForceMultiplier,Values=(1,0.75,0.5,0.25,0))
...
BodyFoodDecayPerSecond,Values=(2,1,1,1,1.15))
```
::: info LAST UPDATED
<span style="color: #ffd369;">07-20-2024 by Mike</span>
:::
...
VenomBiteDamage,Values=(20,30,40,50,60))
VenomBiteBoneBreakChance,Values=(1,1,1,1,1))
VenomBoneBreakAmount,Values=(1,1,1,1,1))
VenomBiteCooldown,Values=(3,3,3,3,3))
VenomBiteStaminaCost,Values=(10,10,10,10,10))
BiteVenomDamage,Values=(1,5,15,30,40))
BiteVenomCooldown,Values=(1.5,1.5,1.5,1.5,1.5))
BiteVenomAmount,Values=(0.15,0.15,0.15,0.15,0.15))
TailDamage,Values=(30,30,30,30,30))
TailBoneBreakChance,Values=(0,0,0,0,0))
TailCooldown,Values=(3,3,3,3,3))
TailRDamage,Values=(30,30,30,30,30))
TailRBoneBreakChance,Values=(0,0,0,0,0))
TailRCooldown,Values=(3,3,3,3,3))
TailLDamage,Values=(30,30,30,30,30))
TailLBoneBreakChance,Values=(0,0,0,0,0))
TailLCooldown,Values=(3,3,3,3,3))
StaminaTrotCostPerSecond,Values=(0,0,0,0,0))
StaminaSprintCostPerSecond,Values=(0.96,1.29,1.63,1.96,2.3))
StaminaSwimgCostPerSecond,Values=(4.79,4.79,4.79,4.79,4.79))
StaminaFastSwimCostPerSecond,Values=(9.58,9.58,9.58,9.58,9.58))
StaminaDiveCostPerSecond,Values=(4.79,4.79,4.79,4.79,4.79))
StaminaFastDiveCostPerSecond,Values=(9.58,9.58,9.58,9.58,9.58))
StaminaJumpCost,Values=(30,30,30,30,30))
BioluminescenceDuration,Values=(300,300,300,300,300))
BioluminescenceCooldown,Values=(300,300,300,300,300))
BioluminescenceStaminaCost,Values=(0,0,0,0,0))
BioluminescenceRadius,Values=(0,0,0,0,0))
...
TyrantRoarDuration,Values=(30,30,30,30,30))
TyrantRoarRoot,Values=(0,0,0,0,0))
TyrantRoarradius,Values=(3000,3000,3000,3000,3000))
