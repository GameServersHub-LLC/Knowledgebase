...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="PTTherizinosaurus.` in front of every line in the `Game.ini` under [/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`PTTherizinosaurus`

## Attributes:
```
Core.MaxHealth,Values=(200,400,525,675,700))
Core.MaxStamina,Values=(100,100,100,100,100))
Core.CombatWeight,Values=(500,1100,2600,3650,6100))
...
Core.HungerDepletionRate,Values=(0.03,0.14,0.25,0.36,0.37))
Core.ThirstDepletionRate,Values=(0.03,0.14,0.17,0.26,0.27))
...
Core.HealthRecoveryRate,Values=(2,1.75,1.5,1.25,0.95))
Core.StaminaRecoveryRate,Values=(1.55,1.3,1,0.6,0.4))
...
BodyFoodDecayPerSecond,Values=(2,1,1,1,1.5))
```
::: info LAST UPDATED
<span style="color: #ffd369;">07-07-2024 by Mike</span>
:::
...
StaminaSprintCostPerSecond,Values=(1.42,1.82,2.02,2.12,2.22))
StaminaSwimgCostPerSecond,Values=(1.61,1.61,1.61,1.61,1.61))
StaminaFastSwimCostPerSecond,Values=(3.03,3.03,3.03,3.03,3.03))
StaminaDiveCostPerSecond,Values=(1.6,1.6,1.6,1.6,1.6))
StaminaFastDiveCostPerSecond,Values=(4,4,4,4,4))
StaminaJumpCost,Values=(13,13,13,13,13))
HeadBiteDamage,Values=(20,20,20,20,20))
HeadBiteBoneBreakChance,Values=(0,0,0,0,0))
HeadBiteBleedAmount,Values=(0,0,0,0,0))
HeadBiteCooldown,Values=(2,2,2,2,2))
HeadBiteStaminaCost,Values=(0,0,0,0,0))
ClawAttackDamage,Values=(40,50,60,70,80))
ClawAttackCooldown,Values=(2,2,2,2,2))
ClawAttackBleed,Values=(0,0,0,0,0))
ClawAttackCost,Values=(0,0,0,0,0))
ClawChargedAttackDamage,Values=(40,80,100,110,120))
ClawChargedAttackBoneBreakChance,Values=(0,0,0,0,0))
ClawChargedAttackBleedAmount,Values=(0,0,0,0,0))
ClawChargedAttackCooldown,Values=(5,5,5,5,5))
ClawChargedAttackStaminaCost,Values=(8,8,8,8,8))
ClawChargedBleedAttackDamage,Values=(50,50,50,50,50))
ClawChargedBleedAttackBoneBreakChance,Values=(0,0,0,0,0))
ClawChargedBleedAttackBleedAmount,Values=(0.75,0.75,0.75,0.75,0.75))
ClawChargedBleedAttackCooldown,Values=(5,5,5,5,5))
ClawChargedBleedAttackStaminaCost,Values=(8,8,8,8,8))
ChargeSpeedIncrease,Values=(500,500,550,600,600))
ChargeDuration,Values=(8,8,8,8,8))
ChargeCooldown,Values=(40,40,40,40,40))
ChargeCost,Values=(24,24,24,24,24))
ChargeDamage,Values=(15,15,15,15,15))
ParryDuration,Values=(3,3,3,3,3))
ParryDamageReduction,Values=(10,10,10,10,10))
ParryCooldown,Values=(5,5,5,5,5))
ParryStaminaCost,Values=(4,4,4,4,4))
BackDodgeSpeedIncrease,Values=(900,900,900,1100,1300))
BackDodgeCooldown,Values=(5,5,5,5,5))
BackDodgeStaminaCost,Values=(4,4,4,4,4))
TailAttackDamage,Values=(30,30,30,30,30))
TailAttackCooldown,Values=(3,3,3,3,3))
ClawBarrageDamage,Values=(6,6,6,6,6))
ClawBarrageCooldown,Values=(1.5,1.5,1.5,1.5,1.5))
...
QuillsHideDamage,Values=(2,4,6,8,10))
NonQuillsStamRecovery,Values=(1.05,1.05,1.05,1.05,1.05))
