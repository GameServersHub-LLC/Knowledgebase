...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Alioramus.` in front of every line in the `Game.ini` under `[/Script/PathOfTitans.IGameSession]`
...
## Attributes:
```cs
Core.MaxHealth",Values=(100,200,300,400,475))
...
Multiplier.StandardSubSpecies.AttackDamageMultiplier",Values=(1.03,1.03,1.03,1.03,1.03))
Multiplier.SpeedySubSpecies.JumpHeight",Values=(1.25,1.25,1.25,1.25,1.25))
...
BiteSmallDamage",Values=(30,35,40,45,55))
BiteSmallBoneBreakChance",Values=(0,0,0,0,0))
BiteSmallBleedAmount",Values=(0,0,0,0,0))
BiteSmallCooldown",Values=(1,1,1,1,1))
BiteSmallStaminaCost",Values=(0,0,0,0,0))
...
BiteHoldDamage",Values=(1,5,10,20,30))
BiteHoldBoneBreakChance",Values=(0,0,0.01,0.03,0.05))
BiteHoldBleedAmount",Values=(0,0,0,0,0))
BiteHoldCooldown",Values=(1,1,1,1,1))
BiteHoldStaminaCost",Values=(10,10,10,10,10))
TailBalanceTurnRadius",Values=(1.05,1.05,1.05,1.05,1.05))
TailBalanceSpeed",Values=(1.15,1.15,1.15,1.15,1.15))
DenseFeathersBleedHeal",Values=(1.4,1.4,1.4,1.4,1.4))
LeapJumpForce",Values=(1.45,1.45,1.45,1.45,1.45))
