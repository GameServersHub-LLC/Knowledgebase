...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Amargasaurus.` in front of every line in the `Game.ini` under `[/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`Amargasaurus`

## Attributes:
```cs
Core.MaxHealth",Values=(200,340,490,625,800))
Core.MaxStamina",Values=(100,100,100,100,100))
Core.CombatWeight",Values=(600,1200,2100,3200,4650))
...
Core.HealthRecoveryRate",Values=(1.17,1.23,1.3,1.44,1.55))
...
HeadbuttDamage",Values=(20,20,25,30,40))
...
TailAttackCooldown",Values=(2.5,2.5,2.5,2.5,2.5))
TailAttackStaminaCost",Values=(0,0,0,0,0))
StompDamage",Values=(60,70,80,90,100))
...
SpikesHideDamage",Values=(9,9,9,9,9))
SpikesHideBleed",Values=(0.4,0.4,0.4,0.4,0.4))
