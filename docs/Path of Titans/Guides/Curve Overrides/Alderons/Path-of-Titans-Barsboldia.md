...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Barsboldia.` in front of every line in the `Game.ini` under `[/Script/PathOfTitans.IGameSession]`
...
Core.ThirstDepletionRate",Values=(0.03,0.16,0.29,0.42,0.48))
...
HeadbuttDamage",Values=(20,25,30,30,35))
HeadbuttBoneBreakChance",Values=(1,1,1,1,1))
...
TailSlamStaminaCost",Values=(0,0,0,0,0))
DefenseBuffCost",Values=(10,10,10,10,10))
DefenseBuffDuration",Values=(60,60,60,60,60))
DefenseBuffMultiplier",Values=(1.5,1.5,1.5,1.5,1.5))
