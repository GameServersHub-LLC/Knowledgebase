...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Camptosaurus.` in front of every line in the `Game.ini` under `[/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`Camptosaurus`
...
Core.HungerDepletionRate",Values=(0.04,0.07,0.1,0.14,0.17))
Core.ThirstDepletionRate",Values=(0.04,0.07,0.1,0.14,0.17))
...
Multiplier.SpeedySubSpecies.JumpMultiplier",Values=(1.25,1.25,1.25,1.25,1.25))
...
## Combat:
```cs
BiteDamage",Values=(10,10,20,20,20))
...
ChargeCooldown",Values=(60,60,60,60,60))
...
AlertCallAttackDamageMultiplier",Values=(1.2,1.2,1.2,1.2,1.2))
HopAwaySpeedIncrease",Values=(900,1100,1500,1600,1700))
HopAwayDuration",Values=(15,15,15,15,15))
HopAwayCooldown",Values=(5,5,5,5,5))
HopAwayCost",Values=(15,15,15,15,15))
HopAwayTurnRadiusMultiplier",Values=(0.5,0.5,0.5,0.5,0.5))
