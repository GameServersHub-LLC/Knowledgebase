...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Concavenator.` in front of every line in the `Game.ini` under `[/Script/PathOfTitans.IGameSession]`
...
BitePoisonAmount",Values=(0,0,0,0,0))
...
ClawDamage",Values=(20,20,30,30,30))
ClawBoneBreakChance",Values=(0,0,0,0,0))
ClawCooldown",Values=(3,3,3,3,3))
ClawBleedAmount",Values=(1,1,1,1,1))
ClawPoisonAmount",Values=(0,0,0,0,0))
ClawVenomAmount",Values=(0,0,0,0,0))
StaminaTrotCostPerSecond",Values=(0,0,0,0,0))
StaminaSprintCostPerSecond",Values=(0.3,0.4,0.5,0.55,0.6))
...
HideScabbingBloodBleedHeal",Values=(1.4,1.4,1.4,1.4,1.4))
...
FrontLimbPaddleSwimSpeed",Values=(1.5,1.5,1.5,1.5,1.5))
FrontLimbPaddleOxygenDepletion",Values=(0.5,0.5,0.5,0.5,0.5))
FrontLimbPaddleSwimTurnRadius",Values=(2,2,2,2,2))
SlicerDamage",Values=(10,10,20,20,20))
SlicerBoneBreakChance",Values=(0,0,0,0,0))
SlicerCooldown",Values=(5,5,5,5,5))
SlicerBleedAmount",Values=(0,0,0,0,0))
SlicerPoisonAmount",Values=(0,0,0,0,0))
SlicerVenomAmount",Values=(0,0,0,0,0))
...
RippingKickBleed",Values=(1,1,1,1,1))
RippingKickCost",Values=(5,5,5,5,5))
BloodthirstyTearDamage",Values=(50,50,50,50,50))
BloodthirstyTearSelfDamagePercent",Values=(0.25,0.25,0.25,0.25,0.25))
BloodthirstyTearCooldown",Values=(6,6,6,6,6))
BloodthirstyTearHealDuration",Values=(5,5,5,5,5))
```
::: info LAST UPDATED
<span style="color: #ffd369;">08-17-2024 by Mike</span>
:::
