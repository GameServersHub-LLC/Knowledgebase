...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Default.` in front of every line in the `Game.ini` under `[/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`Default`

## Attributes:
```cs
Core.MaxHealth",Values=(100,200,300,400,500))
Core.MaxStamina",Values=(50,100,100,100,100))
Core.CombatWeight",Values=(10,20,30,40,50))
