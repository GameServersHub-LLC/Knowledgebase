...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Pachycephalosaurus.` in front of every line in the `Game.ini` under `[/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`Pachycephalosaurus`
...
KickDamage",Values=(10,20,30,35,40))
...
HideLightweightScalesSpeed",Values=(1.05,1.05,1.05,1.05,1.05))
