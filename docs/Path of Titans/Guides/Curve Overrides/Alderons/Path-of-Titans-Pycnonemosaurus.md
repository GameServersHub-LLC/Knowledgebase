...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Pycnonemosaurus.` in front of every line in the `Game.ini` under `[/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`Pycnonemosaurus`
...
Multiplier.BulkySubSpecies.Knockback",Values=(1.15,1.15,1.15,1.15,1.15))
...
HornSwipeDamage",Values=(5,5,5,5,5))
HornSwipeCooldown",Values=(5,5,5,5,5))
HornSwipeStaminaCost",Values=(5,5,5,5,5))
BulldozerKnockbackMultiplier",Values=(1.25,1.25,1.25,1.25,1.25))
