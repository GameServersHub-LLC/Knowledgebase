...
Core.BodyFoodAmount",Values=(100,425,750,1075,2400))
...
Core.HealthRecoveryRate",Values=(1.11,1.03,1,0.98,1))
Core.StaminaRecoveryRate",Values=(1.6,1.3,1,1,1.2))
...
Multiplier.SpeedySubSpecies.LandSpeed",Values=(1.05,1.05,1.05,1.05,1.05))
...
ChargeSpeedIncrease",Values=(400,700,1000,1200,1300))
...
TyrantRoarDuration",Values=(100,100,1000,100,100))
HunkerDownDamageReceived",Values=(0.7,0.7,0.7,0.7,0.7))
...
ToughScutesArmor",Values=(1.15,1.18,1.18,1.18,1.18))
LoneSurvivorArmor",Values=(1.1,1.1,1.1,1.1,1.2))
