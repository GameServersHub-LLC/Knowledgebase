...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Bloop.` in front of every line in the `Game.ini` under `[/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`Bloop`

## Attributes:
```cs
Core.MaxHealth",Values=(600,775,950,1150,1600))
Core.MaxStamina",Values=(200,200,200,200,200))
Core.CombatWeight",Values=(1000,2000,4000,6000,8000))
...
Core.BodyFoodAmount",Values=(100,500,1250,1750,2250))
Core.MaxHunger",Values=(50,250,500,1000,1500))
Core.MaxThirst",Values=(50,250,500,1000,1500))
...
Core.MaxOxygen",Values=(100,100,100,250,350))
...
## Combat:
```cs
BiteDamage",Values=(60,90,110,130,140))
...
StaminaFastSwimCostPerSecond",Values=(1.6,1.6,1.6,1.6,1.6))
StaminaTrotSwimCostPerSecond",Values=(0,0,0,0,0))
StaminaDiveCostPerSecond",Values=(0,0,0,0,0))
StaminaFastDiveCostPerSecond",Values=(1.6,1.6,1.6,1.6,1.6))
...
TailAttackDamage",Values=(50,60,70,80,80))
TailAttackBoneBreakChance",Values=(0,0,0.01,0.03,0.05))
TailAttackBleedAmount",Values=(1,2,3,4,5))
TailAttackCooldown",Values=(1,1,1,1,1))
TailAttackStaminaCost",Values=(10,10,10,10,10))
ChompDamage",Values=(80,80,80,120,120))
ChompBoneBreakChance",Values=(0,0,0.01,0.03,0.05))
ChompBleedAmount",Values=(1,2,3,4,5))
ChompCooldown",Values=(1,1,1,1,1))
