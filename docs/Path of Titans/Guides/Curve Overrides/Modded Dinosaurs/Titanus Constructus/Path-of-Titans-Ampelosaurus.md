...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Ampelosaurus.` in front of every line in the `Game.ini` under [/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`Ampelosaurus`

## Attributes:
```cs
Core.MaxHealth",Values=(200,400,600,800,1000))
Core.MaxStamina",Values=(100,100,100,100,100))
Core.CombatWeight",Values=(600,1600,3200,6500,8300))
Core.Armor",Values=(1.2,1.2,1.2,1.2,1.2))
...
Core.BodyFoodAmount",Values=(200,800,1500,2000,2500))
Core.MaxHunger",Values=(200,400,600,800,1000))
Core.MaxThirst",Values=(200,400,600,800,1000))
Core.HungerDepletionRate",Values=(0.03,0.12,0.21,0.29,0.31))
Core.ThirstDepletionRate",Values=(0.03,0.12,0.21,0.29,0.31))
Core.FoodConsumptionRate",Values=(24,48,72,96,120))
Core.WaterConsumptionRate",Values=(24,48,72,96,120))
Core.MaxOxygen",Values=(50,100,100,100,100))
Core.OxygenDepletionRate",Values=(1.2,1.2,1.2,1.2,1.2))
Core.OxygenRecoveryRate",Values=(8,7,6,5,5))
Core.FallingLegDamage",Values=(10,50,50,50,50))
Core.LegHealRate",Values=(1.2,1,1,1,1))
...
Core.HealthRecoveryRate",Values=(1.2,1.18,1.16,1.12,1.1))
Core.StaminaRecoveryRate",Values=(1.5,1.3,1.1,0.95,0.82))
Core.JumpForceMultiplier",Values=(1,1,1,1,1))
Core.GrowthPerSecond",Values=(1,1,1,1,1))
Core.FallDeathSpeed",Values=(2000,1850,1750,1600,1500))
Core.TurnRadiusMultiplier",Values=(2,1.75,1.5,1.25,1))
Core.TurnInPlaceRadiusMultiplier",Values=(1,1,1,1,1))
Core.SpineDamage",Values=(1,1,1,1,1))
...
## Multipliers:
```cs
Multiplier.HealthRecovery.Resting",Values=(1.15,1.14,1.13,1.12,1.2))
Multiplier.HealthRecovery.Sleeping",Values=(1.8,1.7,1.65,1.6,1.5))
...
Multiplier.StaminaRecovery.Resting",Values=(4.5,4.4,4.3,4.2,4.1))
Multiplier.StaminaRecovery.Sleeping",Values=(5.5,5.3,5.1,5,5))
...
Multiplier.LegHealRate.Resting",Values=(2,1.9,1.8,1.75,1.7))
...
Multiplier.PoisonHealRate.Resting",Values=(1.25,1.2,1.2,1.15,1.15))
...
Multiplier.VenomHealRate.Resting",Values=(3,2.8,2.5,2.5,2.5))
...
Multiplier.VenomHealRate.TrotDiving",Values=(0.75,0.75,0.75,0.75,0.75))
...
Multiplier.HungerDepletionRate.Resting",Values=(1,1,0.98,0.95,0.9))
Multiplier.HungerDepletionRate.Sleeping",Values=(1,1,0.95,0.9,0.9))
...
Multiplier.IncomingDamage.Resting",Values=(1.5,1.5,1.7,2,2))
...
Multiplier.SpeedySubSpecies.Armor",Values=(0.98,0.98,0.98,0.98,0.98))
Multiplier.SpeedySubSpecies.VenomHealRate",Values=(1.2,1.2,1.2,1.2,1.2))
Multiplier.SpeedySubSpecies.StaminaRecovery",Values=(1.2,1.2,1.2,1.2,1.2))
Multiplier.DefenseSubSpecies.Speed",Values=(0.98,0.98,0.98,0.98,0.98))
Multiplier.DefenseSubSpecies.Armor",Values=(1.3,1.3,1.3,1.3,1.3))
Multiplier.DefenseSubSpecies.StaminaRecovery",Values=(0.95,0.95,0.95,0.95,0.95))
Multiplier.DefenseSubSpecies.VenomHealRate",Values=(0.95,0.95,0.95,0.95,0.95))
...
StaminaSprintCostPerSecond",Values=(0.6,0.8,1,1.5,2))
StaminaSwimgCostPerSecond",Values=(10,10,10,10,10))
StaminaTrotSwimCostPerSecond",Values=(10,10,10,10,10))
StaminaFastSwimCostPerSecond",Values=(10,10,10,10,10))
StaminaDiveCostPerSecond",Values=(10,10,10,10,10))
StaminaFastDiveCostPerSecond",Values=(10,10,10,10,10))
StaminaTrotDiveCostPerSecond",Values=(10,10,10,10,10))
StaminaJumpCost",Values=(10,20,30,30,30))
...
TailWhipDamage",Values=(10,20,30,40,50))
TailWhipCooldown",Values=(2,2,2,2,2))
HeadSlapDamage",Values=(5,10,20,35,55))
HeadSlapCooldown",Values=(2,2,2,2,2))
HeadSlapStaminaCost",Values=(3,3,3,3,3))
TailSlamDamage",Values=(13,26,39,52,65))
TailSlamBoneBreakChance",Values=(0.2,0.4,0.6,0.8,1))
TailSlamBoneBreakAmount",Values=(1,2,3,4,5))
TailSlamCooldown",Values=(6,6,6,6,6))
TailSlamStaminaCost",Values=(3,6,9,12,15))
StompDamage",Values=(40,80,12,160,200))
StompBoneBreakChance",Values=(0.5,0.75,0.8,0.9,1))
StompBoneBreakAmount",Values=(2,4,6,8,10))
StompCooldown",Values=(10,10,10,10,10))
StompStaminaCost",Values=(10,10,10,10,10))
StompRadius",Values=(80,150,200,250,300))
StompForwardBackwardMod",Values=(60,120,180,240,300))
StompLeftRightMod",Values=(0,0,0,0,0))
StompUpDownMod",Values=(0,0,0,0,0))
SharpenedSpikesDamage",Values=(0,0.5,1.5,2.5,3))
SharpenedSpikesDamage.Speed",Values=(0,0.42,1.27,2.12,2.55))
SharpenedSpikesDamage.Defense",Values=(0,0.57,1.73,2.88,3.45))
SharpenedSpikesBleedAmount",Values=(0.04,0.08,0.12,0.16,0.2))
SharpenedSpikesBleedAmount.Speed",Values=(0.05,0.1,0.14,0.19,0.24))
SharpenedSpikesBleedAmount.Defense",Values=(0.03,0.06,0.1,0.13,0.16))
BatteringRamDamage",Values=(5,10,15,20,25))
BatteringRamCooldown",Values=(5,5,5,5,5))
BatteringRamStaminaCost",Values=(3,3,3,3,3))
HerdAlertBuffDuration",Values=(60,60,60,60,60))
HerdAlertBuffArmorMultiplier",Values=(2,2,2,2,2))
HerdAlertBuffCooldown",Values=(480,480,480,480,480))
HerdAlertDebuff",Values=(300,300,300,300,300))
HerdAlertBuffCost",Values=(35,35,35,35,35))
HerdAlertBuffRadius",Values=(3000,3000,3000,3000,3000))
FrontKickDamage",Values=(6,12,18,24,30))
FrontKickCooldown",Values=(2,2,2,2,2))
FrontKickStaminaCost",Values=(0,0,0,0,0))
BackKickDamage",Values=(6,12,18,24,30))
BackKickCooldown",Values=(2,2,2,2,2))
BackKickStaminaCost",Values=(0,0,0,0,0))
StrongLungsOxygen",Values=(1,1,1,1,1))
LighterBonesSpeedMultiplier",Values=(1,1,1.15,1.15,1.15))
LighterBonesCombatWeightMultiplier",Values=(1,1,0.9,0.85,0.85))
LighterBonesThirstDepletionRateMultiplier",Values=(1.25,1.25,1.25,1.25,1.25))
DenseBonesSpeedMultiplier",Values=(1,0.98,0.96,0.9,0.85))
DenseBonesCombatWeightMultiplier",Values=(1.05,1.05,1.05,1.05,1.05))
DenseBonesHungerDepletionRateMultiplier",Values=(1.2,1.2,1.2,1.2,1.2))
...
SturdyTractionAmount",Values=(100,100,100,100,100))
```
::: info LAST UPDATED
<span style="color: #ffd369;">08-11-2024 by Mike</span>
:::
