...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Eotriceratops.` in front of every line in the `Game.ini` under `[/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`Eotriceratops`

## Attributes:
```cs
Core.MaxHealth",Values=(300,450,600,755,800))
...
Core.BodyFoodAmount",Values=(10,10,225,1300,1700))
...
SharpenHornsDuration",Values=(60,60,60,60,60))
SharpenHornsDamageMultiplier",Values=(1.3,1.3,1.3,1.3,1.3))
...
BalancedTurning",Values=(1.05,1.05,1.05,1.05,1.05))
