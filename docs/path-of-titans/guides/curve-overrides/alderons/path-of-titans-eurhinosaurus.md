...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Eurhinosaurus.` in front of every line in the `Game.ini` under `[/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`Eurhinosaurus`
...
Core.BodyFoodAmount",Values=(10,10,90,475,600))
...
Multiplier.AttackSubSpecies.AttackDamage",Values=(1.03,1.03,1.03,1.03,1.03))
...
BiteBleedDamage",Values=(0.05,0.05,0.1,0.15,0.2))
ThrashDamage",Values=(10,10,10,10,10))
ThrashCooldown",Values=(4,4,4,4,4))
ThrashBleedDamage",Values=(0.1,0.1,0.15,0.2,0.5))
...
ChatterDuration",Values=(5,5,5,5,5))
ChatterCooldown",Values=(5,5,5,5,5))
ChatterStaminaCost",Values=(1,1,1,1,1))
ChatterSpeedIncrease",Values=(1.02,1.02,1.02,1.02,1.02))
...
TailFanStrength",Values=(400,600,800,1200,1600))
TailFanCooldown",Values=(6,6,6,6,6))
TailFanStaminaCost",Values=(5,5,5,5,5))
TailAttackDamage",Values=(10,20,20,25,25))
TailAttackCooldown",Values=(4,4,4,4,4))
TailAttackStaminaCost",Values=(5,5,5,5,5))
