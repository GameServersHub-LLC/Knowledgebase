...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Sarcosuchus.` in front of every line in the `Game.ini` under `[/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`Sarcosuchus`
...
Core.BodyFoodAmount",Values=(10,10,140,1300,1600))
Core.MaxHunger",Values=(50,237.5,425,612.5,800))
Core.MaxThirst",Values=(50,237.5,425,612.5,800))
Core.HungerDepletionRate",Values=(0.06,0.13,0.16,0.17,0.18))
Core.ThirstDepletionRate",Values=(0.06,0.13,0.16,0.17,0.18))
...
Multiplier.StandardSubSpecies.Damage",Values=(1.03,1.03,1.03,1.03,1.03))
...
StaminaSprintCostPerSecond",Values=(3,3.5,4,5,6.6))
...
BiteTearDamage",Values=(25,25,25,25,25))
BiteTearBoneBreakChance",Values=(0,0,0,0,0))
BiteTearBleedAmount",Values=(0.25,0.25,0.25,0.25,0.25))
BiteTearCooldown",Values=(5,5,5,5,5))
BiteTearStaminaCost",Values=(0,0,0,0,0))
ChompDamage",Values=(100,130,150,180,210))
...
LungeCost",Values=(20,20,20,20,20))
BreachSpeedIncrease",Values=(2000,3000,4000,5000,6000))
BreachDuration",Values=(2.5,2.5,2.5,2.5,2.5))
BreachCooldown",Values=(10,10,10,10,10))
BreachCost",Values=(20,20,15,15,10))
AsphyxiatingSnapDamage",Values=(20,20,20,20,20))
AsphyxiatingSnapOxygenAmount",Values=(15,15,15,15,15))
AsphyxiatingSnapStaminaAmount",Values=(20,20,20,20,20))
AsphyxiatingSnapCooldown",Values=(4,4,4,4,4))
