...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Tyrannosaurus.` in front of every line in the `Game.ini` under `[/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`Tyrannosaurus`
...
Core.BodyFoodAmount",Values=(10,10,200,1500,2000))
Core.MaxHunger",Values=(50,237.5,425,700,1000))
Core.MaxThirst",Values=(50,237.5,425,700,1000))
Core.HungerDepletionRate",Values=(0.06,0.12,0.16,0.19,0.22))
Core.ThirstDepletionRate",Values=(0.06,0.12,0.16,0.19,0.22))
...
TailAttackDamage",Values=(10,20,20,25,30))
...
BoneSnapStaminaCost",Values=(20,20,20,20,20))
ChargeDamage",Values=(20,40,60,80,80))
