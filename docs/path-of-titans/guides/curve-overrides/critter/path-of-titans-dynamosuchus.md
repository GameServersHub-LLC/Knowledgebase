...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Dynamosuchus.` in front of every line in the `Game.ini` under `[/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`Dynamosuchus`

## Attributes:
```cs
Core.HitsToKill",Values=(25,25,25,25,25))
...
Core.FearedCombatWeight",Values=(2500,2500,2500,2500,2500))
...
## Combat:
```cs
BaseAttack.AttackDamage",Values=(35,35,35,35,35))
BaseAttack.BleedAmount",Values=(0.25,0.25,0.25,0.25,0.25))
