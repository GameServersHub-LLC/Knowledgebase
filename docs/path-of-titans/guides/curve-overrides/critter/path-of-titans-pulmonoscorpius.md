...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Pulmonoscorpius.` in front of every line in the `Game.ini` under `[/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`Pulmonoscorpius`
...
Core.RunSpeed",Values=(400,400,400,400,400))
Core.TurnRadius",Values=(70,70,70,70,70))
...
## Combat:
```cs
BaseAttack.AttackDamage",Values=(40,40,40,40,40))
BaseAttack.BleedAmount",Values=(0,0,0,0,0))
BaseAttack.VenomAmount",Values=(0.5,0.5,0.5,0.5,0.5))
