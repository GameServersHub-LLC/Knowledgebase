...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Wadiasaurus.` in front of every line in the `Game.ini` under `[/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`Wadiasaurus`

## Attributes:
```cs
Core.HitsToKill",Values=(50,50,50,50,50))
