...
> [!IMPORTANT]
>Please be sure to add `CurveOverrides=(CurveName="Wonambi.` in front of every line in the `Game.ini` under `[/Script/PathOfTitans.IGameSession]`

::: warning
The server must be stopped while editing server files. You must save your edits and restart your server for any edits to take effect.
:::

Listed below are the default stats for the following creature:`Wonambi`

## Attributes:
```cs
Core.HitsToKill",Values=(10,10,10,10,10))
...
Core.RunSpeed",Values=(300,300,300,300,300))
...
BaseAttack.VenomAmount",Values=(0.25,0.25,0.25,0.25,0.25))
